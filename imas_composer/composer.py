"""
ImasComposer - Generic composition engine for IMAS data.

This module is intentionally free of any data-backend dependencies (MDSplus,
ptdata, OMAS, etc.).  It only knows how to resolve data requirements and
compose IDS values from already-fetched raw data.  See imas_composer.fetchers
for concrete data retrieval utilities.
"""
