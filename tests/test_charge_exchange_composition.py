...
Single parametric test that verifies compose() matches OMAS for all Charge Exchange fields.
"""
...
def test_composition_matches_omas(ids_path, composer, omas_data, test_shot):
    """Test that composed data matches OMAS for each Charge Exchange field."""
