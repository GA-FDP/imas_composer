"""
Test Gas Injection IDS requirement resolution.

Single parametric test that verifies resolve() can fully resolve all requirements
for each gas injection field, tracking resolution depth.
"""
import pytest
...
def test_can_resolve_requirements(ids_path, composer, test_shot):
    """Test that resolve() can fully resolve requirements for each gas injection field."""
