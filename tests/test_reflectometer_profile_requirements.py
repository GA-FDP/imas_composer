"""
Test reflectometer_profile IDS requirement resolution.

Single parametric test that verifies resolve() can fully resolve all requirements
for each reflectometer_profile field, tracking resolution depth.
"""
import pytest
...
def test_can_resolve_requirements(ids_path, composer):
    """Test that resolve() can fully resolve requirements for each reflectometer_profile field."""
